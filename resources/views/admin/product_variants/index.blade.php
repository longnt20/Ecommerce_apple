                    ...
                    <div class="listjs-table" id="customerList">
                        <div class="row g-4 mb-3">
                            <div class="col-sm-auto">
                                <div>
                                    <a href="{{ route('admin.product_variants.create') }}" class="btn btn-success add-btn"><i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-1">
                                                    <div class="edit">
                                                        <form action="{{ route('admin.product_variants.edit', $item->id) }}"
                                                            method="get">
                                                            @csrf
                                                    ...
                                                    <div class="show">
                                                        <form action="{{ route('admin.product_variants.show', $item->id) }}"
                                                            method="get">
                                                            @csrf
                                                    ...
                                                    <div class="remove">
                                                        <form method="POST"
                                                            action="{{ route('admin.product_variants.destroy', $item->id) }}"
                            ...
                            <div class="pagination-wrap hstack gap-2">
                                ...
                                @else
                                    <a class="page-item pagination-prev"
                                        href="{{ $productVariants->previousPageUrl() }}">Previous</a>
                                @endif

                                {{-- Các số trang --}}
                                <ul class="pagination listjs-pagination mb-0">
                                    @foreach ($productVariants->getUrlRange(1, $productVariants->lastPage()) as $page => $url)
                                        <li class="page-item {{ $page == $productVariants->currentPage() ? 'active' : '' }}">
                                ...
                                @if ($productVariants->hasMorePages())
                                    <a class="page-item pagination-next" href="{{ $productVariants->nextPageUrl() }}">Next</a>
                                @else
