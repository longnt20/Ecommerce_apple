                    ...
                    <form action="{{ route('admin.product-attributes.update', $productAttribute) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="type" class="form-select @error('type') is-invalid @enderror">
                                ...
                                @foreach($types as $key => $label)
                                    <option value="{{ $key }}" {{ old('type', $productAttribute->type) == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="value" class="form-control @error('value') is-invalid @enderror" 
                                   value="{{ old('value', $productAttribute->value) }}">
                            @error('value')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="label" class="form-control @error('label') is-invalid @enderror" 
                                   value="{{ old('label', $productAttribute->label) }}">
                            @error('label')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="sort_order" class="form-control @error('sort_order') is-invalid @enderror" 
                                   value="{{ old('sort_order', $productAttribute->sort_order) }}">
                            @error('sort_order')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input type="checkbox" name="is_active" class="form-check-input" 
                                       id="is_active" value="1" {{ old('is_active', $productAttribute->is_active) ? 'checked' : '' }}>
