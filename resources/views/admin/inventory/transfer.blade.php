        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <textarea name="notes" class="form-control" rows="4" placeholder="Ghi chú về phiếu chuyển kho..."></textarea>
                    </div>
                </div>
    ...
    `;
        ...
        function updateSummary() {
            ...
            quantities.forEach(input => {
                       ...
                       const match = input.name.match(/items```math(\d+)```/);
                       if (match) {
