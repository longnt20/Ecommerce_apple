...
import SubBanner1 from '@/assets/Right-S25-FE.webp'
import SubBanner2 from '@/assets/AW11-right-banner.webp'
import SubBanner3 from '@/assets/Camp-laptop-T9_Right-banner-1.webp'
