...
const categories = [
  { id: 1, name: 'Tập luyện thể thao', icon: iphone16promax },
  { id: 2, name: 'Nghe gọi', icon: iphone17pro256gb },
  { id: 3, name: 'Vòng đeo tay thông minh', icon: iphone15plus11 },
  { id: 4, name: 'Định vị trẻ em', icon: iphone17256gb32 },
  { id: 5, name: 'Đo huyết áp', icon: iphoneair32 },
]
