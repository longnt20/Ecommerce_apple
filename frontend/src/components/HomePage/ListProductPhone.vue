                ...
                <div class="branch-24">
                  <RouterLink class="pro-card" :to="{ name: 'product-detail', params: { slug: product.slug } }">
                    ...
                    <div class="branch-29">
                      ...
                      <button data-slot="button" class="cpsui-button" @click.stop.prevent="handleWishlist(product)">
                        <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24"
                          stroke-linecap="round" stroke-linejoin="round" class="favourite" :class="{ active: wishlist.isWishlisted(product.id) }"
...
import iphone17pro256gb from '@/assets/iphone-17-pro-256-gb.webp'
import iphone15plus11 from '@/assets/iphone-15-plus_1__1.webp'
import iphone17256gb32 from '@/assets/iphone_17_256gb-3_2.webp'
import iphoneair32 from '@/assets/iphone_air-3_2.webp'
const categories = [
  { id: 1, name: 'Điện thoại chơi game', icon: iphone16promax },
  { id: 2, name: 'Điện thoại pin trâu', icon: iphone17pro256gb },
  { id: 3, name: 'Điện thoại 5G', icon: iphone15plus11 },
  { id: 4, name: 'Điện thoại chụp ảnh đẹp', icon: iphone17256gb32 },
  { id: 5, name: 'Điện thoại vừa tay', icon: iphoneair32 },
]
...
const handleWishlist = async (product) => {
  await wishlist.toggle(product.product_id, product.id)

  if (wishlist.isWishlisted(product.id)) {
    toast.info('Đã thêm sản phẩm vào yêu thích')
  } else {
...
const initSwiper = async () => {
  ...
  swiperInstance.value = new Swiper('.product-swiper', {
